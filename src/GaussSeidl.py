...
from src.algorithms import dot_product
from src.preparareMatrix import preparareMatrix


def GaussSeidl(N, a1, a2, a3, debug=False):
    ...
    while err > 1e-9:
        for m in range(N):
            ...
            xn[0][m] = (b[0][m] - s1 - s2) / M[m][ m]

        residuum = al.sub2(al.dot_product_matrix(M, xn) , b)
...
if __name__ == "__main__":
    GaussSeidl(5, 13, -1, -1, debug=True)
